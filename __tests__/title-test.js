jest.dontMock('../components/title.js');    //tell it not to mock what u want to test

var React = require('react/addons'),      // get access to React 
    Title = require('../components/title.js'),   // put your function that you want to test into a var 
